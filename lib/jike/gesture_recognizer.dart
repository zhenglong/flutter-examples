...
abstract class _DragGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  void addPointer(PointerDownEvent event) {
    ...
    if (_state == _DragState.ready) {
      ...
      if (onDown != null) {
        invokeCallback('onDown', () => onDown(DragDownDetails(globalPosition: _initialPosition)));
      }
    ...
    if (_state != _DragState.accepted) {
      ...
      if (onStart != null) {
        invokeCallback<void>('onStart', 
          () => onStart(DragStartDetails(sourceTimeStamp: timestamp, globalPosition: _initialPosition)));
      }
  ...
  void didStopTrackingLastPointer(int pointer) {
    ...
    if (wasAccepted && onEnd != null) {
      ...
      if (estimate != null && _isFlingGesture(estimate)) {
        ...
        invokeCallback('onEnd', () => onEnd(DragEndDetails(
          velocity: velocity,
...
class DirectionGestureRecognizer extends _DragGestureRecognizer {
  ...
  DirectionGestureRecognizer(this.direction, {Object debugOwner}) : super(debugOwner: debugOwner);
...
class IgnorePanGestureRecognizer extends _DragGestureRecognizer {
  ...
  bool _isFlingGesture(VelocityEstimate estimate) {
    ...
    return estimate.pixelsPerSecond.distanceSquared > pow(minVelocity, 2) &&
      estimate.offset.distanceSquared > pow(minDistance, 2);
  }
