...
class DrinkShopColors {
  static final Color backgroundColor = Color(0xFF251829);
  ...
  static final Color carouselCardColor = new Color(0xFFEE8AE1);
  static final Color carouselCardBackColor = new Color(0xFFD67CCA);
  static final Color carouselCardLineColor = new Color(0xFFEEABE1);
}